...
import 'package:myapp/services/EOSService.dart';
import 'package:myapp/services/SecureStorage/SecureStorageInterface.dart';
import 'package:myapp/services/SecureStorage/WebSecureStorage.dart';
  ...
  WalletAccount accountFromJson(String walletAccountAsString) {
    try {
      ...
      return WalletAccount(
          map['accountName'],
          map['publicKey'],
          EOSService.eosNetworks[
              networkName != null ? networkName.toLowerCase() : 'jungle2'],
